...
im = Image.open('data/peacock.png')
...
im2.save('data/peacock_head.png','PNG')
...
im3.save('data/peacock_head_bright.png','PNG')
...
im4.save('data/peacock_head_dark.png','PNG')
...
im5.save('data/gradient.png','PNG')